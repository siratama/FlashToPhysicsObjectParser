...
Main.prototype = {
	...
	,outputCircle: function() {
		console.log("---");
		var physicsObject;
		physicsObject = this.flashToPhysicsObjectParser.getPhysicsObject(this.sampleCircle,this.sampleCircle.ball);
		console.log(physicsObject);
	...
	,outputPolygon: function() {
		console.log("---");
		var polygon;
		polygon = this.flashToPhysicsObjectParser.getPhysicsObject(this.samplePolygon,this.samplePolygon.flipper);
		console.log(polygon);
